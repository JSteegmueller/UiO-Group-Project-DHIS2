...
import { CircularLoader, DropdownButton, Button, FlyoutMenu, MenuItem } from "@dhis2/ui";
...
function RequestCommodity(props) {
    const commoditiesList =
        props.commodityValue.sendBy === "Dispensing"
            ? props.commodityValue.commoditiesValueSet
            : collectingOrgDataHelperBrowse(props.commodityValue.commoditiesValueSet).dropdownList;
